@file:JvmName("ImplPartialQuantified3")
...
/**
 * Data class to hold three typed parameters for partial quantified node processing.
 *
 ...
 * @property third List of values of type T3
 */
data class ImplPartialQuantified3Params<T1, T2, T3>(
    val first: List<T1>,
    val second: List<T2>,
    val third: List<T3>
)
 ...
 * @param quantity3 Required quantity of T3 events
...
inline fun <EIn : Any,
    ...
    noinline action: suspend (ImplPartialQuantified3Params<T1, T2, T3>) -> EOut
    ...
    private val thirdSet = mutableListOf<T3>()
